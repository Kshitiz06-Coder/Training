...
// console.log(a);
// let na ="Kshitiz"? console.log("Kshitiz"):console.log("User");
...
// const b = (a/2) ? console.log("odd") : console.log("even");

// let num1=10,num2=20,num3=30,num4;
...
//     ]
// }
// console.log(kshitiz.arr[0].score[2]);
...
// console.log(kathford.bca.arr[2]);
...
// console.log(obj.posts[0].id);
// console.log(obj.posts[1].title);
...
// const numb=[1,2,3,4,5,6,7]      /*for print all in arr*/
...
// for(let i=0;i<numb.length;i++){
//   if(numb[i]%2==0){
//     console.log(`This value is odd: ${numb[i]}`);
//   }
// }
